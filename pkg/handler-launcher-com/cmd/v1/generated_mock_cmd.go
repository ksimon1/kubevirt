...
func (m *MockCmdClient) SetGuestAgentPaused(ctx context.Context, in *GuestAgentPausedRequest, opts ...grpc.CallOption) (*Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "SetGuestAgentPaused", varargs...)
	ret0, _ := ret[0].(*Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCmdClientMockRecorder) SetGuestAgentPaused(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetGuestAgentPaused", reflect.TypeOf((*MockCmdClient)(nil).SetGuestAgentPaused), varargs...)
}
...
// SetGuestAgentPaused mocks base method.
func (m *MockCmdServer) SetGuestAgentPaused(arg0 context.Context, arg1 *GuestAgentPausedRequest) (*Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetGuestAgentPaused", arg0, arg1)
	ret0, _ := ret[0].(*Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// SetGuestAgentPaused indicates an expected call of SetGuestAgentPaused.
func (mr *MockCmdServerMockRecorder) SetGuestAgentPaused(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetGuestAgentPaused", reflect.TypeOf((*MockCmdServer)(nil).SetGuestAgentPaused), arg0, arg1)
}
